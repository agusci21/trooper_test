...
export const createTablesIfNotExists = async () => {
    ...
    await createTeacherTableIfNotExist()
...
const createTeacherTableIfNotExist = async () => {
    TeacherDTO.sync().then(() => {
        console.log("Table created: Teacher")
    }).catch((_) => {
        console.log(_)
        console.log("could not create table Teacher")
    })
}
...
const generateSeedData = async () => {
    ...
    //await SeedDataHelper.generateTeachersSeedData()
}